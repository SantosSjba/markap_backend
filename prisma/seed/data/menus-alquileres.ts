 ...
 * Clientes (propietarios e inquilinos) → Propiedades → Agentes → Alquileres → Cobranzas → Reportes → Config
 */
export const ALQUILERES_PARENT_MENUS = [
  ...
  { label: 'Agentes', icon: 'user-check', path: '/alquileres/agentes', order: 3 },
  { label: 'Alquileres', icon: 'file-text', path: '/alquileres/contratos', order: 4 },
...
export const ALQUILERES_CHILD_MENUS = [
  // Propietarios primero: toda propiedad requiere dueño
  { label: 'Propietarios', path: '/alquileres/clientes/propietarios', order: 0, parentLabel: 'Clientes' },
  { label: 'Listado de Clientes', path: '/alquileres/clientes', order: 1, parentLabel: 'Clientes' },
