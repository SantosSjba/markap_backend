...
export const SAMPLE_OWNER_CLIENT = {
  ...
  fullName: seedPrueba('Juan Pérez García'),
  primaryPhone: '999888777',
  primaryEmail: 'juan.perez.prueba@ejemplo.com',
};

export const SAMPLE_TENANT_CLIENT = {
  documentNumber: '87654321',
  fullName: seedPrueba('María López Sánchez'),
  primaryPhone: '988777666',
  primaryEmail: 'maria.lopez.prueba@ejemplo.com',
};

export const SAMPLE_OWNER_ADDRESS = {
  addressType: 'FISCAL' as const,
  addressLine: seedPrueba('Av. Principal 123, Lima'),
  isPrimary: true,
};

export const SAMPLE_PROPERTY = {
  code: 'PROP-SEED-001',
  addressLine: seedPrueba('Calle Las Flores 456, Miraflores'),
  description: seedPrueba('Departamento amplio, buena iluminación.'),
  area: 85.5,
  bedrooms: 2,
  bathrooms: 2,
  monthlyRent: 1500,
...
export const SAMPLE_RENTAL = {
  ...
  notes: seedPrueba('Contrato seed - datos de prueba.'),
};
...
export const SAMPLE_EXTERNAL_AGENT = {
  fullName: seedPrueba('Carlos Inmobiliaria SAC'),
  email: 'contacto.prueba@carlosinmobiliaria.com',
  phone: '955444333',
...
export const SAMPLE_RENTAL_ATTACHMENT = {
  ...
  originalFileName: 'contrato-ejemplo-prueba.pdf',
};

export const SAMPLE_NOTIFICATION = {
  type: 'RENTAL_CREATED' as const,
  title: seedPrueba('Bienvenido al sistema'),
  body: seedPrueba('Mensaje de ejemplo. El seed ha creado datos básicos en todas las tablas.'),
  data: { source: 'seed' },
};
