...
import { ContabilidadJournalEntriesController } from './controllers/contabilidad-journal-entries.controller';
import { ContabilidadTreasuryController } from './controllers/contabilidad-treasury.controller';
import { ContabilidadPurchasesController } from './controllers/contabilidad-purchases.controller';
import { ContabilidadSalesController } from './controllers/contabilidad-sales.controller';
import { ContabilidadTaxesController } from './controllers/contabilidad-taxes.controller';
import { ContabilidadPleController } from './controllers/contabilidad-ple.controller';
...
import { ContabilidadInventoryController } from './controllers/contabilidad-inventory.controller';
import { ContabilidadLegalEntitiesController } from './controllers/contabilidad-legal-entities.controller';
import { ContabilidadAuditController } from './controllers/contabilidad-audit.controller';
import { ContabilidadCpeController } from './controllers/contabilidad-cpe.controller';
import { ContabilidadSolController } from './controllers/contabilidad-sol.controller';
...
import {
  ...
  ContabilidadJournalOperationsService,
  ContabilidadTreasuryOperationsService,
  ContabilidadPurchasesOperationsService,
  ContabilidadSalesOperationsService,
  ContabilidadTaxesOperationsService,
  ContabilidadPleOperationsService,
  ...
  ContabilidadInventoryOperationsService,
  ContabilidadContextService,
  ContabilidadLegalEntityOperationsService,
  ContabilidadAuditOperationsService,
  ContabilidadCpeOperationsService,
  ContabilidadCpeUblService,
  ContabilidadCpeEmitterService,
  ContabilidadSolOperationsService,
...
@Module({
  ...
  controllers: [
    ...
    ContabilidadJournalEntriesController,
    ContabilidadTreasuryController,
    ContabilidadPurchasesController,
    ContabilidadSalesController,
    ContabilidadTaxesController,
    ContabilidadPleController,
    ...
    ContabilidadInventoryController,
    ContabilidadLegalEntitiesController,
    ContabilidadAuditController,
    ContabilidadCpeController,
    ContabilidadSolController,
