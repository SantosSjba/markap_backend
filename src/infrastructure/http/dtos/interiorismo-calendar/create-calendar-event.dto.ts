...
export class CreateInteriorCalendarEventDto {
  @ApiProperty({ enum: TYPES })
  @IsString()
  @IsIn(TYPES)
  eventType!: string;

  @ApiProperty({ example: 'Revisión avances con cliente' })
  @IsString()
  @MaxLength(500)
  title!: string;
  ...
  @ApiPropertyOptional({ description: 'Opcional; vacío = agenda general / equipo' })
  @IsOptional()
