...
export { ARQUITECTURA_CONFIG_REPOSITORY } from '@domain/repositories/arquitectura-config.repository';
...
export { ARQUITECTURA_CATALOG_MATERIAL_REPOSITORY } from '@domain/repositories/arquitectura-catalog-material.repository';
export { ARQUITECTURA_MATERIAL_SUPPLIER_REPOSITORY } from '@domain/repositories/arquitectura-material-supplier.repository';
export { ARQUITECTURA_REPORTS_REPOSITORY } from '@domain/repositories/arquitectura-reports.repository';
...
export { CONTABILIDAD_REPORTS_REPOSITORY } from '@domain/repositories/contabilidad-reports.repository';
export { CONTABILIDAD_EXTENSIONS_REPOSITORY } from '@domain/repositories/contabilidad-extensions.repository';
export { CONTABILIDAD_INVENTORY_REPOSITORY } from '@domain/repositories/contabilidad-inventory.repository';
export { CONTABILIDAD_LEGAL_ENTITY_REPOSITORY } from '@domain/repositories/contabilidad-legal-entity.repository';
export { CONTABILIDAD_AUDIT_REPOSITORY } from '@domain/repositories/contabilidad-audit.repository';
export { CONTABILIDAD_CPE_REPOSITORY } from '@domain/repositories/contabilidad-cpe.repository';
export { CONTABILIDAD_SOL_REPOSITORY } from '@domain/repositories/contabilidad-sol.repository';
